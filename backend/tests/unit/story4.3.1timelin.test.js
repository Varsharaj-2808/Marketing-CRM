...
jest.mock("../../src/models/Lead", () => ({ findById: jest.fn() }));
jest.mock("../../src/models/Followup", () => ({ findByLeadId: jest.fn() }));
jest.mock("../../src/models/LeadHistory", () => ({ findByLeadId: jest.fn() }));
jest.mock("../../src/models/AuditLog", () => ({ create: jest.fn() }));
jest.mock("../../src/models/User", () => ({ findByIdOrEmployeeId: jest.fn(), findById: jest.fn(), findByEmail: jest.fn(), updateAccountStatus: jest.fn() }));
jest.mock("../../src/models/LeadSource", () => ({ findAll: jest.fn() }));
jest.mock("../../src/models/BusinessCategory", () => ({ findAll: jest.fn() }));
jest.mock("../../src/models/BusinessSubCategory", () => ({ findAll: jest.fn() }));
jest.mock("../../src/models/Service", () => ({ findAll: jest.fn() }));
...
jest.mock("../../src/utils/emailService",  () => ({ sendWelcomeEmail: jest.fn().mockResolvedValue(), sendDailyReminderEmail: jest.fn().mockResolvedValue() }));
...
jest.mock("../../src/controllers/userController",          () => mockController(["createUser","getUsers","getDeactivatedUsers","reindexUsers","getUser","updateUser","deleteUser"]));
jest.mock("../../src/controllers/auditLogController",       () => mockController(["getAuditLogs","getAuditLog","exportAuditLogs","archiveAuditLogs"]));
jest.mock("../../src/controllers/systemSettingController",  () => mockController(["getSettings","updateSetting","getAuditRetention","updateAuditRetention"]));
jest.mock("../../src/controllers/savedViewController",     () => mockController(["createSavedView","updateSavedView","deleteSavedView"]));
jest.mock("../../src/controllers/bulkOperationsController", () => mockController(["bulkSelect","bulkAssign","exportLeads"]));
jest.mock("../../src/controllers/assignController",         () => mockController(["assignLead"]));
jest.mock("../../src/controllers/categoryController",       () => mockController([
...
const LeadHistory = require("../../src/models/LeadHistory");
