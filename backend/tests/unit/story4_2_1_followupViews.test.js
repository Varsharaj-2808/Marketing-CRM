...
jest.mock("../../src/models/User",            () => ({}), { virtual: true });
jest.mock("../../src/models/LeadHistory",     () => ({}), { virtual: true });
jest.mock("../../src/models/AuditLog",        () => ({}), { virtual: true });
jest.mock("../../src/models/LeadSource",      () => ({}), { virtual: true });
jest.mock("../../src/models/BusinessCategory",     () => ({}), { virtual: true });
jest.mock("../../src/models/BusinessSubCategory",  () => ({}), { virtual: true });
jest.mock("../../src/models/Service",         () => ({}), { virtual: true });
jest.mock("pdfkit", () => ({}));
