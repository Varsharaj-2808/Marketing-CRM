  ...
  return (
      <main className="w-full max-w-[384px] px-4 md:px-0 mx-auto min-h-dvh flex items-center justify-center py-6 relative">
        ...
        <div className="glass-card rounded-3xl p-5 md:p-6 w-full relative overflow-hidden animate-fade-in-up">
          ...
          <form className="space-y-4" onSubmit={handleSubmit} noValidate data-testid="loginForm" style={{ animation: 'fade-in-up 0.6s 0.2s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
            <AlertBanner show={!!resetSuccess} type="success" icon="check_circle" className="!bg-emerald-50 !border-emerald-200 !text-emerald-800">
          ...
          <div className="mt-4" style={{ animation: 'fade-in-up 0.6s 0.28s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
            <button
              type="button"
          ...
          <div className="mt-5 pt-5 border-t border-outline-variant/30 text-center" style={{ animation: 'fade-in-up 0.6s 0.35s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
