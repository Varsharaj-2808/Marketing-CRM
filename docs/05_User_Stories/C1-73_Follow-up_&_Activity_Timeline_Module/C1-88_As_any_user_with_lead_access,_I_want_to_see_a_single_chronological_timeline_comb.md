...
- **C1-89:** [TASK-4.3.1-01] Design Timeline UI component (vertical chronological feed) on Lead Detail page- **C1-90:** [TASK-4.3.1-02] Build GET /leads/{id}/timeline API aggregating: Lead Created, Assigned/Reassigned, Stage Changed, Follow-up Logged, Won/Lost events- **C1-91:** [TASK-4.3.1-03] Implement event icons/colors per event type- **C1-92:** [TASK-4.3.1-04] Implement filter chips on timeline (All / Follow-ups / Stage Changes / Assignment)- **C1-93:** [TASK-4.3.1-05] Ensure timeline is read-only and strictly append-only (no edit/delete of historical entries)- **C1-94:** [TASK-4.3.1-06] Paginate or lazy-load timeline for leads with long histories
