...
- **C1-54:** [TASK-2.4.1-01] Build Stage selector on Lead Detail (New Lead -> Contacted -> Meeting Scheduled -> Requirement Gathering -> Proposal Sent -> Negotiation -> Won/Lost/Hold)- **C1-55:** [TASK-2.4.1-02] Build PATCH /leads/{id}/stage API with allowed-transition validation- **C1-56:** [TASK-2.4.1-03] Enforce mandatory Lost Reason capture when Stage = Lost- **C1-57:** [TASK-2.4.1-04] Enforce mandatory final Deal Value + Closure Date capture when Stage = Won- **C1-58:** [TASK-2.4.1-05] Write Stage-Changed event to Lead History (old stage -> new stage, actor, timestamp)- **C1-59:** [TASK-2.4.1-06] Lock stage edits on Won/Lost leads except for Admin override
