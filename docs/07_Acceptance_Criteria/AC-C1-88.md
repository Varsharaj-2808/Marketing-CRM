...
jira-key: C1-88
source-type: Story
source-summary: [STORY-4.3.1] As any user with lead access, I want to see a single chronological timeline combining creation, assignment, stage changes, and follow-ups so that I un...
status: To Do
updated: 2026-06-26 05:14:40
---

# Acceptance Criteria: C1-88

**Source:** C1-88 - [STORY-4.3.1] As any user with lead access, I want to see a single chronological timeline combining creation, assignment, stage changes, and follow-ups so that I un...
**Issue Type:** Story
